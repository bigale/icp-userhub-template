...
import { useExtensionMode } from "./useExtensionMode";
  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
      {isLoading ? (
        ...
        <div className={`flex min-h-screen flex-col ${mode === "sidepanel" ? "text-sm" : ""}`}>
          <Header />
          <main className="flex-1">
            {!isAuthenticated ? (
              <div className="mx-auto flex min-h-[calc(100vh-8rem)] items-center justify-center px-4">
                <div className="text-center">
                  <h1 className={`mb-4 font-bold tracking-tight ${mode === "sidepanel" ? "text-2xl" : "text-4xl"}`}>
                    Welcome
                  </h1>
